...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_task_fingerprints_owner_id"), "task_fingerprints", ["owner_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_feedback_events_owner_id"), "feedback_events", ["owner_id"], unique=False
    )
    op.create_index(
        op.f("ix_feedback_events_task_id"), "feedback_events", ["task_id"], unique=False
    )
    ...
    op.create_index(
        "ix_event_log_stream", "event_log", ["stream_type", "stream_id", "seq"], unique=False
    )
    ...
    op.create_index(
        "ix_idempotency_lookup", "idempotency_keys", ["owner_id", "route", "key"], unique=False
    )
    op.create_index(
        op.f("ix_idempotency_keys_owner_id"), "idempotency_keys", ["owner_id"], unique=False
    )
